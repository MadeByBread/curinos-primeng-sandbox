...
const routes: Routes = [
  ...
  { path: 'dashboard-default', component: PrimengDashboardComponent },
  {
    ...
    loadChildren: './primeng-defaults/component-default/component-default.module#ComponentDefaultModule'
  },
  // Superseded by the component catalogue; kept so old links resolve.
  { path: 'transition-default', redirectTo: 'components-default' },
